...
exports.getCheckMultIp = function getCheckMultIp(data,vote,res) {
...
exports.getResultVote = function getResultVote(id){
    connection.query('SELECT COUNT( * ) AS cnt, vote FROM votes where id_quest ='+id+' GROUP BY vote ORDER BY  "cnt"',function(error, result){
       console.log(result);
    });
};