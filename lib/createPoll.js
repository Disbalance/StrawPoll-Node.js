...
req.on('readable', function() {
    ...
    /*var data = {quest: database.getQuestDB(1), options : database.getOptionDB(1)};
    console.log(data.quest+' '+data.options);*/
    database.getDataDB(1);
    /*console.log(database.getOptionDB(1));*/
};
